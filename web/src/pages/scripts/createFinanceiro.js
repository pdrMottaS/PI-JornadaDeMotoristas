...
function CreateFinanceiro(){
    //formulario deve ser um componente para ser usado na página home
    const [nome,setNome]=useState();
    const [cpf,setCpf]=useState();
    const [email,setEmail]=useState();
    
    async function cadastrarFinanceiro(e){
        
        e.preventDefault();

        let userFinanceiro = new Object();
        userFinanceiro = {
            nome:nome,
            email:email,
            cpf:cpf,       
    ...
    return(
        <div>
            <Header text="Cadastro de Financeiro" auth={true}/>
            <h4 id="msg-cadastro">Insira os dados cadastrais do Financeiro:</h4>
            <form onSubmit={cadastrarFinanceiro}>
...
export default CreateFinanceiro;