        ...
        try{
            ...
            for(let i in res.data){
                if(res.data[i].matricula!=localStorage.getItem("id")){
                    ...
                    result.push({nome:res.data[i].nome,cargo:cargo,matricula:res.data[i].matricula,cpf:res.data[i].cpf});
               }
            }
                     ...
                     <div className="lista-resultados" id="exibirColabs">
                         {colaboradores.map(colaborador=>(
                             <div className="colaborador-pesquisa" key={colaborador.matricula}>
                                ...
                                <label className="indice-cargo">CPF:</label>
                                <label className="dados-pesquisa-cargo">{colaborador.cpf}</label>
